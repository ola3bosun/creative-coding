...
})(
  {
    ...
    2: [
      function (t, e, n) {
        ...
        function p(t, e) {
          return ((e = i(e, 0)), "number" == typeof t && isFinite(t) ? t : e);
        }
        function c(t) {
          if ("number" != typeof t)
          ...
          return function (e, n) {
            ...
            ((n = i(n, 0)),
              null == e
                ? (r = n)
                : "number" == typeof e && isFinite(e) && (r = e));
            var o,
              s = [];
            if (null == r) for (o = 0; o < t; o++) s[o] = p(e[o], n);
            else for (o = 0; o < t; o++) s[o] = r;
            return s;
          };
        }
        function d(t, e, n, i) {
          if (((i = i || []), t.length !== e.length))
            throw new TypeError(
              "min and max array are expected to have the same length",
            );
          for (var r = 0; r < t.length; r++) i[r] = a(t[r], e[r], n);
          return i;
        }
        function h(t, e) {
          if ("number" != typeof (t = i(t, 0)))
        ...
        e.exports = {
          ...
          linspace: function (t, e) {
            if ("number" != typeof (t = i(t, 0)))
              throw new TypeError("Expected n argument to be a number");
            "boolean" == typeof (e = e || {}) && (e = { endpoint: !0 });
            var n = i(e.offset, 0);
            return e.endpoint
              ? h(t).map(function (e, i) {
                  return t <= 1 ? 0 : (i + n) / (t - 1);
                })
              : h(t).map(function (e, i) {
                  return (i + n) / t;
                });
          ...
          lerpFrames: function (t, e, n) {
            ...
            var i = t.length - 1,
              ...
              c = t[o % t.length],
              h = t[p % t.length];
            if ("number" == typeof c && "number" == typeof h) return a(c, h, l);
            if (Array.isArray(c) && Array.isArray(h)) return d(c, h, l, n);
            throw new TypeError(
          ...
          damp: v,
          dampArray: function (t, e, n, i, r) {
            r = r || [];
            for (var o = 0; o < t.length; o++) r[o] = v(t[o], e[o], n, i);
            return r;
          },
          mapRange: function (t, e, n, i, r, s) {
            if (Math.abs(e - n) < o) return i;
            var a = ((t - e) / (n - e)) * (r - i) + i;
            return (
              s &&
                (r < i
    ...
    3: [
        ...
        e.exports = (function t(e) {
          ...
          return (
            d(e),
            {
              ...
              rangeFloor: f,
              pick: function (t) {
                return 0 === t.length ? void 0 : t[f(0, t.length)];
              },
              shuffle: function (t) {
                if (!Array.isArray(t))
              ...
              insideSphere: function (t, e) {
                ...
                var n = h() * Math.PI * 2,
                  ...
                  l = t * Math.cbrt(r);
                return (
                  (e[0] = l * Math.sin(a) * Math.cos(s)),
                  (e[1] = l * Math.sin(a) * Math.sin(s)),
                  (e[2] = l * Math.cos(a)),
                  e
                );
              },
              quaternion: function (t) {
                ...
                var e = h(),
                  ...
                  c = Math.sin(a) * o,
                  d = Math.cos(a) * o;
                return ((t[0] = l), (t[1] = p), (t[2] = c), (t[3] = d), t);
              },
              weighted: _,
              weightedSet: function (t) {
                return 0 === (t = t || []).length ? null : t[g(t)].value;
              },
              weightedSetIndex: g,
              gaussian: function (t, e) {
                if (((t = o(t, 0)), (e = o(e, 1)), c)) {
                  c = !1;
                  var n = p;
                  return ((p = null), t + e * n);
                }
      ...
      { defined: 5, "seed-random": 6, "simplex-noise": 7 },
    ],
    4: [
      function (t, e, n) {
        (function (t) {
            ...
            !(function (t, i) {
              ...
              var v,
                          ...
                          (t instanceof Date && o instanceof Date
                            ...
                            : !t ||
                              ...
                              : (function (t, o, s) {
                                  ...
                                  for (
                                    p.sort(), c.sort(), a = p.length - 1;
                                    a >= 0;
                                    a--
                                  )
                                    if (p[a] != c[a]) return !1;
                                  for (a = p.length - 1; a >= 0; a--)
                                    if (!n(t[(l = p[a])], o[l], s)) return !1;
                        ...
                        function (t, s, a, l) {
                          ...
                          var d = a ? "getUTC" : "get",
                            ...
                            C = {
                              ...
                              m: v + 1,
                              mm: o(v + 1),
                              mmm: r.i18n.monthNames[v],
                              mmmm: r.i18n.monthNames[v + 12],
                              yy: String(m).slice(2),
                              yyyy: m,
                              h: f % 12 || 12,
                              hh: o(f % 12 || 12),
                          ...
                          return s.replace(e, function (t) {
                            return t in C ? C[t] : t.slice(1, t.length - 1);
                          });
                        });
                    function o(t, e) {
                ...
                w = function (t, e) {
                  ...
                  if (2 === e) return t + t;
                  var n = t.length * e;
                  if (v !== t || void 0 === v) ((v = t), (_ = ""));
                  else if (_.length >= n) return _.substr(0, n);
                  for (; n > _.length && e > 1; )
                    (1 & e && (_ += t), (e >>= 1), (t += t));
                  return (_ = (_ += t).substr(0, n));
                };
              var y,
                x = function () {},
                C = { extension: "", prefix: "", suffix: "" },
                P = ["image/png", "image/jpeg", "image/webp"];
              function k(t, e) {
                return (
                  void 0 === e && (e = {}),
                  new Promise(function (n, i) {
                    ...
                    return a && a.output && "function" == typeof a[s]
                      ? a[s](r({}, e, { filename: o })).then(function (t) {
                          return n(t);
                        })
                      : n({ filename: o, client: !1 });
                  })
                );
              }
              function E(t, e) {
              ...
              function V(t, e) {
                return (
                  ...
                  new Promise(function (n) {
                    var i = (e = r({}, C, e)).filename,
                      o = c();
                    if (o && "function" == typeof o.saveBlob && o.output)
                      return o
                        .saveBlob(t, r({}, e, { filename: i }))
                        .then(function (t) {
                          return n(t);
                        });
                    (y ||
                      (((y = document.createElement("a")).style.visibility =
                        "hidden"),
                      (y.target = "_blank")),
                      (y.download = i),
              ...
              function M(t) {
                ...
                var l =
                  ...
                  t.totalLayers > 1
                    ...
                    : "";
                return null != s
                  ? [l, s].filter(Boolean).join("-") + a
                  : [t.prefix, t.name || t.timeStamp, l, t.hash, t.suffix]
                      .filter(Boolean)
                      .join("-") + a;
              }
              var S = {
              ...
              var O = function (t, e, n, i) {
                ...
                var c = j[e],
                  d = j[n],
                  h = t * c.factor * l;
                c.system !== d.system && (h *= R[c.system].ratio);
                var u = (h / d.factor) * a;
                return (
                  p && s
                    ? (u = Math.round(u))
              ...
              function F(t, e, n, i) {
                return (
                  ...
                  void 0 === n && (n = "px"),
                  void 0 === i && (i = 72),
                  O(t, e, n, { pixelsPerInch: i, precision: 4, roundPixel: !0 })
                );
              }
              function N(t, e) {
                var n,
                ...
                var f,
                  ...
                  _ =
                    ...
                    isFinite(e.pixelsPerInch)
                      ...
                      : 72,
                  w = d(e.bleed, 0),
                  y = l ? window.devicePixelRatio : 1,
                  x = m ? y : 1;
                ("number" == typeof e.pixelRatio && isFinite(e.pixelRatio)
                  ? (b = d(e.exportPixelRatio, (f = e.pixelRatio)))
                  : c
                    ? ((f = x), (b = d(e.exportPixelRatio, 1)))
                    : (b = d(e.exportPixelRatio, (f = y))),
                  "number" == typeof e.maxPixelRatio &&
                    isFinite(e.maxPixelRatio) &&
                    (f = Math.min(e.maxPixelRatio, f)),
                  u && (f = b));
                var C,
                  P,
                  k = (function (t, e) {
                ...
                if (
                  ...
                  var R = n / i,
                    O = E / V,
                    N = d(e.scaleToFitPadding, 40),
                    I = Math.round(E - 2 * N),
                    U = Math.round(V - 2 * N);
                  (r > I || o > U) &&
                    (O > R
                      ? ((o = U), (r = Math.round(o * R)))
                      : ((r = I), (o = Math.round(r / R))));
                }
                return {
                  bleed: w,
                  pixelRatio: f,
                  ...
                  dimensions: [n, i],
                  units: g || "px",
                  scaleX: (s = m ? Math.round(f * r) : Math.round(f * T)) / n,
                  scaleY: (a = m ? Math.round(f * o) : Math.round(f * j)) / i,
                  pixelsPerInch: _,
                  viewportWidth: m ? Math.round(r) : Math.round(T),
                  viewportHeight: m ? Math.round(o) : Math.round(j),
                  canvasWidth: s,
                  canvasHeight: a,
                  trimWidth: C,
                  trimHeight: P,
              ...
              function U(t) {
                ...
                if (!1 !== t.canvas) {
                  if (!(e = t.context) || "string" == typeof e) {
                    ...
                    if (!(e = I(s, r({}, t.attributes, { canvas: o }))))
                      throw new Error(
              ...
              ((B.sketch.get = function () {
                return this._sketch;
              }),
                (B.settings.get = function () {
                  return this._settings;
                }),
                (B.props.get = function () {
                  return this._props;
                }),
                (K.prototype._computePlayhead = function (t, e) {
                  return "number" == typeof e && isFinite(e) ? t / e : 0;
                }),
                (K.prototype._computeFrame = function (t, e, n, i) {
                  return isFinite(n) && n > 1
                    ? Math.floor(t * (n - 1))
                    : Math.floor(i * e);
                }),
                (K.prototype._computeCurrentFrame = function () {
                ...
                (K.prototype._getSizeProps = function () {
                  var t = this.props;
                  return {
                    width: t.width,
                    height: t.height,
                ...
                (K.prototype._cancelTimeouts = function () {
                  (null != this._raf &&
                    "undefined" != typeof window &&
                ...
                (K.prototype.togglePlay = function () {
                ...
                (K.prototype._signalBegin = function () {
                  var t = this;
                  this.sketch &&
                ...
                (K.prototype._signalEnd = function () {
                  var t = this;
                  this.sketch &&
                ...
                (K.prototype.endRecord = function () {
                  var t,
                    e = this,
                ...
                (K.prototype._createExportOptions = function (t) {
                  return (
                    void 0 === t && (t = {}),
                    {
                      sequence: t.sequence,
                      ...
                      timeStamp:
                        t.timeStamp || g(new Date(), "yyyy.mm.dd-HH.MM.ss"),
                ...
                (K.prototype.exportFrame = function (t) {
                  var e = this;
                  ...
                  if (i && t.commit && "function" == typeof i.commit) {
                    var s = r({}, n),
                      a = i.commit(s);
                    o = l(a) ? a : Promise.resolve(a);
                  }
                  return o
                    .then(function (t) {
                      return e._doExportFrame(r({}, n, { hash: t || "" }));
                    })
                    .then(function (t) {
                      return 1 === t.length ? t[0] : t;
                    });
                }),
                (K.prototype._doExportFrame = function (t) {
                  var e = this;
                  (void 0 === t && (t = {}),
                    ...
                    Promise.all(
                      n.map(function (e, n, i) {
                        var o = r(
                          ...
                          s = !1 !== t.save && e.save;
                        for (var a in ((o.save = !1 !== s),
                        (o.filename = M(o)),
                        delete o.encoding,
                        delete o.encodingQuality,
                        o))
                          void 0 === o[a] && delete o[a];
                        var l = Promise.resolve({});
                        if (o.save) {
                          var p = o.data;
                          if (o.dataURL) l = E(o.dataURL, o);
                          else
                            l = (function (t, e) {
                              void 0 === e && (e = {});
                      ...
                      if (i.length > 0) {
                        ...
                        var l = "";
                        if (t.sequence)
                          l = isFinite(e.props.totalFrames)
                            ? " (frame " +
                              (t.frame + 1) +
                              " / " +
                              e.props.totalFrames +
                ...
                (K.prototype._wrapContextScale = function (t) {
                  (this._preRender(), t(this.props), this._postRender());
                }),
                (K.prototype._preRender = function () {
                  var t = this.props;
                  u(t.context) && !t.p5
                    ? (t.context.save(),
                ...
                (K.prototype._postRender = function () {
                  var t = this.props;
                  (u(t.context) && !t.p5 && t.context.restore(),
                    t.gl &&
                      !1 !== this.settings.flush &&
                      !t.p5 &&
                      t.gl.flush());
                }),
                ...
                (K.prototype.submitDrawCall = function () {
                  if (this.sketch) {
                    var t,
                      e = this.props;
                    return (
                ...
                (K.prototype.update = function (t) {
                  ...
                  var l = this.getTimeProps(a);
                  if (
                    (Object.assign(this._props, l),
                    i !== this._settings.canvas || r !== this._settings.context)
                  ) {
                    var p = U(this._settings),
                      c = p.context;
                    ((this.props.canvas = p.canvas),
                  ...
                  c &&
                    ...
                    (n.p5
                      ? (c.width === s && c.height === a) ||
                        ...
                        (this._isP5Resizing = !1))
                      : (c.width !== s && (c.width = s),
                        c.height !== a && (c.height = a)),
                    h() &&
                      !1 !== e.styleCanvas &&
                      ((c.style.width = l + "px"),
                      (c.style.height = p + "px")));
                  var d = this._getSizeProps(),
                    u = !b(t, d);
                  return (u && this._sizeChanged(), u);
                }),
                (K.prototype._sizeChanged = function () {
                  this.sketch &&
                    ...
                    if (h()) {
                      ...
                      "fixed" === s
                        ...
                        : "throttle" === s
                          ...
                          : (this._lastTime = t);
                      var l = n / 1e3,
                        p = this.props.time + l * this.props.timeScale;
                      p < 0 && r && (p = i + p);
                      var c = !1,
                        d = !1;
                      if (
                        ...
                        ((this.props.deltaTime = l),
                          (this.props.time = p),
                          (this.props.playhead = this._computePlayhead(p, i)));
                        var u = this.props.frame;
                        ((this.props.frame = this._computeCurrentFrame()),
                          d && this._signalBegin(),
                          u !== this.props.frame && this.tick(),
                          this.render(),
                          (this.props.deltaTime = 0));
                      }
                      c && this.pause();
                ...
                (K.prototype.dispatch = function (t) {
                  if ("function" != typeof t)
                    throw new Error("must pass function into dispatch()");
                  (t(this.props), this.render());
                }),
                (K.prototype.mount = function () {
                  this._appendCanvasIfNeeded();
                }),
                (K.prototype.unmount = function () {
                  (h() &&
                ...
                (K.prototype._appendCanvasIfNeeded = function () {
                  h() &&
                ...
                (K.prototype._setupGLKey = function () {
                  var t;
                  this.props.context &&
                ...
                (K.prototype.getTimeProps = function (t) {
                  void 0 === t && (t = {});
                  var e = t.duration,
                    n = t.totalFrames,
                    i = d(t.timeScale, 1),
                  ...
                  var p = t.time,
                    c = t.frame,
                    h = "number" == typeof p && isFinite(p),
                    u = "number" == typeof c && isFinite(c),
                    v = 0,
                    m = 0,
                    f = 0;
                  if (h && u)
                  ...
                  return (
                    h
                      ? ((f = this._computePlayhead((v = p), e)),
                        (m = this._computeFrame(f, v, n, r)))
                      : u && (f = this._computePlayhead((v = (m = c) / r), e)),
                    {
                      playhead: f,
                      time: v,
                      frame: m,
                ...
                (K.prototype.loadAndRun = function (t, e) {
                  var n = this;
                ...
                (K.prototype.load = function (t, e) {
                  ...
                  return i
                    .then(function () {
                      var e = t(n.props);
                      return (l(e) || (e = Promise.resolve(e)), e);
                    })
                    .then(function (t) {
                      return (
                        t || (t = {}),
              ...
              function q(t, e) {
                ...
                var n,
                  i,
                  r = (n = c()) && n.hot;
                r && (i = d(e.id, "$__DEFAULT_CANVAS_SKETCH_ID__$"));
              ...
              return ((q.canvasSketch = q), (q.PaperSizes = A), q);
            });
          }).call(this);
        }).call(
          this,
        ...
        (function (t) {
          (function () {
            ...
            function c(t) {
              ...
              for (i || (t = [i++]); o < n; ) a[o] = o++;
              for (o = 0; o < n; o++)
                ((a[o] = a[(s = l & (s + t[o % i] + (e = a[o])))]), (a[s] = e));
              (r.g = function (t) {
                for (var e, i = 0, o = r.i, s = r.j, a = r.S; t--; )
                  ((e = a[(o = l & (o + 1))]),
                    (i =
                      i * n +
                      a[l & ((a[o] = a[(s = l & (s + e))]) + (a[s] = e))]));
            ...
            function h(t, e) {
              for (var n, i = t + "", r = 0; r < i.length; )
                e[l & r] = l & ((n ^= 19 * e[l & r]) + i.charCodeAt(r++));
              return u(e);
            }
            function u(t) {
              return String.fromCharCode.apply(0, t);
            }
            ((e.exports = function (t, l) {
              if (l && !0 === l.global)
                return (
                  (l.global = !1),
                  (Math.random = e.exports(t, l)),
                  (l.global = !0),
                  Math.random
                );
              var p = [],
        ...
        !(function () {
                        ...
                        r =
                          ...
                          function (t) {
                            ...
                            for (var e = 0; e < t.length; e++) {
                              var n =
                                0.02519603282416938 * (o += t.charCodeAt(e));
                              ((n -= o = n >>> 0),
                                (o = (n *= o) >>> 0),
                                (o += 4294967296 * (n -= o)));
                            }
          ...
          ((l.prototype = {
            ...
            noise2D: function (e, n) {
              ...
              if (P >= 0) {
                var k = 3 * s[x + a[C]];
                p = (P *= P) * P * (l[k] * f + l[k + 1] * b);
              }
              var E = 0.5 - g * g - _ * _;
              if (E >= 0) {
                var V = 3 * s[x + r + a[C + o]];
                c = (E *= E) * E * (l[V] * g + l[V + 1] * _);
              }
              var M = 0.5 - w * w - y * y;
              if (M >= 0) {
                var S = 3 * s[x + 1 + a[C + 1]];
                d = (M *= M) * M * (l[S] * w + l[S + 1] * y);
              }
              return 70 * (p + c + d);
            },
            noise3D: function (t, e, n) {
              ...
              C >= P
                ? P >= k
                  ? ((p = 1), (c = 0), (d = 0), (h = 1), (u = 1), (v = 0))
                  : C >= k
                    ? ((p = 1), (c = 0), (d = 0), (h = 1), (u = 0), (v = 1))
                    : ((p = 0), (c = 0), (d = 1), (h = 1), (u = 0), (v = 1))
                : P < k
                  ? ((p = 0), (c = 0), (d = 1), (h = 0), (u = 1), (v = 1))
                  : C < k
                    ? ((p = 0), (c = 1), (d = 0), (h = 0), (u = 1), (v = 1))
                    : ((p = 0), (c = 1), (d = 0), (h = 1), (u = 1), (v = 0));
              var E = C - p + o,
                V = P - c + o,
                M = k - d + o,
                S = C - h + 2 * o,
              ...
              if (N < 0) i = 0;
                ...
                var I = 3 * m[R + f[O + f[F]]];
                i = (N *= N) * N * (b[I] * C + b[I + 1] * P + b[I + 2] * k);
              }
              var U = 0.6 - E * E - V * V - M * M;
              if (U < 0) s = 0;
              else {
                var K = 3 * m[R + p + f[O + c + f[F + d]]];
                s = (U *= U) * U * (b[K] * E + b[K + 1] * V + b[K + 2] * M);
              }
              var B = 0.6 - S * S - L * L - D * D;
              if (B < 0) a = 0;
              else {
                var H = 3 * m[R + h + f[O + u + f[F + v]]];
                a = (B *= B) * B * (b[H] * S + b[H + 1] * L + b[H + 2] * D);
              }
              var z = 0.6 - A * A - T * T - j * j;
              if (z < 0) l = 0;
              else {
                var q = 3 * m[R + 1 + f[O + 1 + f[F + 1]]];
                l = (z *= z) * z * (b[q] * A + b[q + 1] * T + b[q + 2] * j);
              }
              return 32 * (i + s + a + l);
            },
            noise4D: function (t, e, n, i) {
              ...
              var I = D - (d = R >= 3 ? 1 : 0) + a,
                ...
                it = 255 & M,
                rt = 255 & S,
                ot = 0.6 - D * D - A * A - T * T - j * j;
              if (ot < 0) r = 0;
              else {
                var st = (C[et + C[nt + C[it + C[rt]]]] % 32) * 4;
                r =
                  (ot *= ot) *
                  ot *
                  (P[st] * D + P[st + 1] * A + P[st + 2] * T + P[st + 3] * j);
              }
              var at = 0.6 - I * I - U * U - K * K - B * B;
              if (at < 0) o = 0;
              else {
                var lt =
                  (C[et + d + C[nt + h + C[it + u + C[rt + v]]]] % 32) * 4;
                o =
                  (at *= at) *
                  at *
                  (P[lt] * I + P[lt + 1] * U + P[lt + 2] * K + P[lt + 3] * B);
              }
              var pt = 0.6 - H * H - z * z - q * q - $ * $;
              if (pt < 0) l = 0;
              else {
                var ct =
                  (C[et + m + C[nt + f + C[it + b + C[rt + g]]]] % 32) * 4;
                l =
                  (pt *= pt) *
                  pt *
                  (P[ct] * H + P[ct + 1] * z + P[ct + 2] * q + P[ct + 3] * $);
              }
              var dt = 0.6 - G * G - Y * Y - W * W - Q * Q;
              if (dt < 0) p = 0;
              else {
                var ht =
                  (C[et + _ + C[nt + w + C[it + y + C[rt + x]]]] % 32) * 4;
                p =
                  (dt *= dt) *
                  dt *
                  (P[ht] * G + P[ht + 1] * Y + P[ht + 2] * W + P[ht + 3] * Q);
              }
              var ut = 0.6 - X * X - Z * Z - J * J - tt * tt;
              if (ut < 0) c = 0;
              else {
                var vt =
                  (C[et + 1 + C[nt + 1 + C[it + 1 + C[rt + 1]]]] % 32) * 4;
                c =
                  (ut *= ut) *
                  ut *
                  (P[vt] * X + P[vt + 1] * Z + P[vt + 2] * J + P[vt + 3] * tt);
              }
              return 27 * (r + o + l + p + c);
            },
          }),
            (l._buildPermutationTable = p),
            ...
            void 0 !== n
              ? (n.SimplexNoise = l)
              : "undefined" != typeof window && (window.SimplexNoise = l),
      ...
      function (t, e, n) {
        !(function (t, i) {
          ...
          const c = {
            ...
            nomatchingcontroller: (t) =>
              `No matching controller for '${t.key}'`,
            nomatchingview: (t) =>
          ...
          class d {
            ...
            constructor(t) {
              var e;
              ((this.message =
                null !== (e = c[t.type](t.context)) && void 0 !== e
                  ? e
                  : "Unexpected error"),
          ...
          class h {
            ...
            writeProperty(t, e) {
              const n = this.read();
              if (!h.isBindable(n)) throw d.notBindable();
          ...
          class v {
            ...
            off(t, e) {
              ...
              return (
                n && (this.observers_[t] = n.filter((t) => t.handler !== e)),
                this
              );
            }
            emit(t, e) {
          ...
          function g(t, e) {
            var n, i;
            (t.emitter.on("change", ((n = b), (i = e), (t) => i(n(t)))),
              e(t.rawValue));
          }
          function _(t, e, n) {
            g(t.value(e), n);
          ...
          function V(t, e) {
            return (null == e ? void 0 : e.constraint) ||
              (null == e ? void 0 : e.equals)
              ? new k(t, e)
              : new E(t);
          }
          class M {
          ...
          function L(t) {
            return {
              custom: (e) => S(e)(t),
              boolean: S((t) => ("boolean" == typeof t ? t : void 0))(t),
              number: S((t) => ("number" == typeof t ? t : void 0))(t),
              string: S((t) => ("string" == typeof t ? t : void 0))(t),
              function: S((t) => ("function" == typeof t ? t : void 0))(t),
              constant: (e) => S((t) => (t === e ? e : void 0))(t),
              raw: S((t) => t)(t),
              object: (e) =>
                S((t) => {
                  var n;
          ...
          const D = { optional: L(!0), required: L(!1) };
          function A(t, e) {
            const n = D.required.object(e)(t);
          ...
          class F extends M {
            constructor(t) {
              ...
              (super(t),
                ...
                this.value("disabled").emitter.on(
                  "change",
            ...
            bindClassModifiers(t) {
              (g(this.globalDisabled_, O(t, "disabled")),
                _(this, "hidden", O(t, "hidden")));
            }
            bindDisabled(t) {
              g(this.globalDisabled_, (e) => {
                t.disabled = e;
              });
            }
            bindTabIndex(t) {
          ...
          function q(t, e) {
            const n = t.createElementNS(K, "svg");
          ...
          class X {
            constructor(t, e) {
              ...
              (n.classList.add(Q("l")),
                _(e.props, "label", (e) => {
                  a(e)
                    ? this.element.classList.add(Q(void 0, "nol"))
                    : (this.element.classList.remove(Q(void 0, "nol")),
                      (function (t) {
            ...
            constructor(t, e) {
              ...
              (super(
                Object.assign(Object.assign({}, e), {
                  view: new X(t, { props: e.props, viewProps: n }),
                  viewProps: n,
                }),
              ),
                (this.props = e.props),
          ...
          const J = {
            ...
            controller: (t) =>
              new Z(t.document, {
                blade: t.blade,
                props: M.fromObject({ label: t.params.label }),
                valueController: new P(t.document, {
                  props: M.fromObject({ title: t.params.title }),
                  viewProps: t.viewProps,
                }),
              }),
            api: (t) =>
              t.controller instanceof Z &&
              t.controller.valueController instanceof P
                ? new u(t.controller)
                : null,
          };
          class tt extends U {
          ...
          function et() {
            return new M({ positions: V([], { equals: l }) });
          }
          class nt extends M {
            constructor(t) {
              super(t);
            ...
            get styleExpanded() {
              var t;
              return null !== (t = this.get("temporaryExpanded")) &&
                void 0 !== t
                ? t
                : this.get("expanded");
            }
          ...
          function rt(t, e) {
            (t.value("expanded").emitter.on("beforechange", () => {
              if ((t.set("completed", !1), a(t.get("expandedHeight")))) {
          ...
          function ut(t, e, n) {
            if (!h.isBindable(t)) throw d.notBindable();
            return new h(t, e, n);
          }
          class vt extends e {
            constructor(t, e) {
              (super(t),
                ...
                (this.onRackMonitorUpdate_ =
                  this.onRackMonitorUpdate_.bind(this)),
                (this.emitter_ = new v()),
                (this.apiSet_ = new st(dt)),
                (this.pool_ = e));
            ...
            get children() {
              return this.controller_.rack.children.map((t) =>
                ht(this.apiSet_, t),
              );
            }
            addInput(t, e, n) {
              const i = null != n ? n : {},
                r = this.pool_.createInput(
            ...
            addSeparator(t) {
              return (function (t, e) {
                return t.addBlade(
                  Object.assign(Object.assign({}, null != e ? e : {}), {
                    view: "separator",
                  }),
                );
              })(this, t);
            ...
            add(t, e) {
              ...
              const n = this.apiSet_.find(
                (e) => e.controller_ === t.controller_,
              );
            ...
            addBlade(t) {
              const e = this.pool_.createBlade(
                  this.controller_.view.element.ownerDocument,
                  t,
                ),
                n = this.pool_.createBladeApi(e);
            ...
            onRackRemove_(t) {
              if (t.isRoot) {
                const e = ht(this.apiSet_, t.bladeController);
            ...
            onRackMonitorUpdate_(t) {
              if (!(t.bladeController instanceof ct))
                throw d.shouldNeverHappen();
              const e = ht(this.apiSet_, t.bladeController),
                n = t.bladeController.binding;
              this.emitter_.emit("update", {
                event: new r(e, n.target.read(), n.target.presetKey),
              });
            }
          }
          class mt extends ot {
            constructor(t, e) {
              (super(t, new vt(t.rackController, e)),
                (this.emitter_ = new v()),
          ...
          class wt {
            constructor(t) {
              ...
              ((this.onBladePositionsChange_ =
                ...
                (this.emitter = new v()),
                (this.blade_ =
                  null !== (e = t.blade) && void 0 !== e ? e : null),
                null === (n = this.blade_) ||
                  void 0 === n ||
                  n
                    .value("positions")
            ...
            updatePositions_() {
              const t = this.bcSet_.items.filter(
                  (t) => !t.viewProps.get("hidden"),
                ),
                e = t[0],
                n = t[t.length - 1];
            ...
            onChildInputChange_(t) {
              const e = (function (t, e) {
                for (let n = 0; n < t.length; n++) {
                  const i = t[n];
                  if (i instanceof lt && i.binding === e) return i;
                }
                return null;
              })(this.find(lt), t.sender);
            ...
            onChildValueChange_(t) {
              const e = (function (t, e) {
                for (let n = 0; n < t.length; n++) {
                  const i = t[n];
                  if (i instanceof tt && i.value === e) return i;
                }
                return null;
              })(this.find(tt), t.sender);
              if (!e) throw d.alreadyDisposed();
              this.emitter.emit("inputchange", {
                bladeController: e,
                options: t.options,
          ...
          class yt extends U {
            constructor(t, e) {
              (super(
                Object.assign(Object.assign({}, e), {
                  view: new bt(t, { viewName: "brk", viewProps: e.viewProps }),
                }),
              ),
                (this.onRackAdd_ = this.onRackAdd_.bind(this)),
                (this.onRackRemove_ = this.onRackRemove_.bind(this)));
            ...
            onRackAdd_(t) {
              t.isRoot &&
                $(this.view.element, t.bladeController.view.element, t.index);
            }
            onRackRemove_(t) {
              t.isRoot && G(t.bladeController.view.element);
            }
          }
          const xt = f("cnt");
          class Ct {
            constructor(t, e) {
              ...
              ((this.className_ = f(
                ...
                (this.element = t.createElement("div")),
                this.element.classList.add(this.className_(), xt()),
                e.viewProps.bindClassModifiers(this.element),
              ...
              (o.classList.add(this.className_("t")),
                y(e.props.value("title"), o),
                this.buttonElement.appendChild(o),
                (this.titleElement = o));
              const s = t.createElement("div");
              (s.classList.add(this.className_("m")),
          ...
          class Pt extends ft {
            constructor(t, e) {
              ...
              (super(
                ...
                (this.props = e.props),
                (this.foldable = i),
                rt(this.foldable, this.view.containerElement),
          ...
          const kt = {
            ...
            api: (t) =>
              t.controller instanceof Pt ? new mt(t.controller, t.pool) : null,
          };
          class Et extends tt {
            constructor(t, e) {
              const n = e.valueController.viewProps;
          ...
          const Dt = {
              ...
              type: "blade",
              accept(t) {
                const e = A(t, { view: D.required.constant("separator") });
                return e ? { params: e } : null;
              },
              controller: (t) =>
                new Lt(t.document, { blade: t.blade, viewProps: t.viewProps }),
              api: (t) =>
                t.controller instanceof Lt ? new Vt(t.controller) : null,
            },
            At = f("tbi");
          class Tt {
            constructor(t, e) {
              ((this.element = t.createElement("div")),
                ...
                _(e.props, "selected", (t) => {
                  t
                    ? this.element.classList.add(At(void 0, "sel"))
                    : this.element.classList.remove(At(void 0, "sel"));
                }));
              const n = t.createElement("button");
              (n.classList.add(At("b")),
                e.viewProps.bindDisabled(n),
                this.element.appendChild(n),
                (this.buttonElement = n));
              const i = t.createElement("div");
              (i.classList.add(At("t")),
                y(e.props.value("title"), i),
                this.buttonElement.appendChild(i),
                (this.titleElement = i));
            }
          ...
          class Rt {
            constructor(t, e) {
              ((this.onItemClick_ = this.onItemClick_.bind(this)),
                ...
                (this.cc_ = new yt(t, { blade: et(), viewProps: F.create() })),
                (this.props = e.props),
          ...
          class Ft extends ot {
            constructor(t, e) {
              (super(t, new vt(t.rackController, e)),
                ...
                this.controller_.pageSet.emitter.on(
                  "remove",
                  this.onPageRemove_,
                ),
            ...
            addPage(t) {
              const e = new Rt(this.controller_.view.element.ownerDocument, {
                itemProps: M.fromObject({ selected: !1, title: t.title }),
                props: M.fromObject({ selected: !1 }),
              });
              this.controller_.add(e, t.index);
            ...
            onSelect_(t) {
              this.emitter_.emit("select", { event: new s(this, t.rawValue) });
            }
          }
          class Nt {
            constructor() {
            ...
            add(t, e) {
              (this.items_.splice(null != e ? e : this.items_.length, 0, t),
          ...
          class Ut {
            constructor(t, e) {
              ((this.element = t.createElement("div")),
                this.element.classList.add(It(), xt()),
                e.viewProps.bindClassModifiers(this.element),
                g(e.empty, w(this.element, It(void 0, "nop"))));
              const n = t.createElement("div");
              (n.classList.add(It("t")),
                this.element.appendChild(n),
                (this.itemsElement = n));
              const i = t.createElement("div");
              (i.classList.add(It("i")), this.element.appendChild(i));
              const r = e.contentsElement;
              (r.classList.add(It("c")),
                this.element.appendChild(r),
          ...
          class Kt extends ft {
            constructor(t, e) {
              const n = new yt(t, { blade: e.blade, viewProps: e.viewProps }),
                i = new Nt();
              (super({
                blade: e.blade,
                rackController: n,
            ...
            onPageRemove_(t) {
              const e = t.item;
              (G(e.itemController.view.element),
          ...
          const Bt = {
            ...
            controller(t) {
              const e = new Kt(t.document, {
                blade: t.blade,
                viewProps: t.viewProps,
              });
              return (
                t.params.pages.forEach((n) => {
                  const i = new Rt(t.document, {
                    itemProps: M.fromObject({ selected: !1, title: n.title }),
                    props: M.fromObject({ selected: !1 }),
                  });
                  e.add(i);
                }),
            ...
            api: (t) =>
              t.controller instanceof Kt ? new Ft(t.controller, t.pool) : null,
          };
          class Ht {
            constructor() {
          ...
          class Zt {
            constructor(t) {
              this.values = M.fromObject({ max: t.max, min: t.min });
            }
            constrain(t) {
          ...
          class Jt {
            constructor(t) {
              this.values = M.fromObject({ options: t });
            }
            get options() {
          ...
          class ie {
            constructor(t, e) {
              ...
              (i.classList.add(ne("m")),
                ...
                _(this.props_, "options", (e) => {
                  (Y(this.selectElement),
                    e.forEach((e) => {
                      const n = t.createElement("option");
                      ((n.textContent = e.text),
                        this.selectElement.appendChild(n));
                    }),
                    this.update_());
                }));
            }
            update_() {
              ...
              this.selectElement.selectedIndex = t.indexOf(
          ...
          class re {
            ...
            onSelectChange_(t) {
              ...
              this.value.rawValue =
                this.props.get("options")[e.selectedIndex].value;
            }
          }
          const oe = f("pop");
          class se {
            constructor(t, e) {
              ((this.element = t.createElement("div")),
                ...
                e.viewProps.bindClassModifiers(this.element),
                g(e.shows, w(this.element, oe(void 0, "v"))));
            }
          }
          class ae {
            constructor(t, e) {
          ...
          class ce {
            ...
            onInputChange_(t) {
              const e = this.parser_(t.currentTarget.value);
              (a(e) || (this.value.rawValue = e), this.view.refresh());
            }
          }
          function de(t) {
            return "false" !== t && !!t;
          ...
          class me {
            ...
            evaluate() {
              ...
              if (!t)
                throw new Error(
                  `unexpected binary operator: '${this.operator}`,
                );
          ...
          function xe(t, e) {
            ...
            return ((e += i.length), "" === i ? "" : i + we(t, e));
          }
          const Ce = ge([
            function (t, e) {
              const n = xe(t, e);
              if ("" === n) return "";
              const i = t.substr((e += n.length), 1);
              if ("." !== i) return "";
              const r = we(t, (e += i.length));
              return n + i + r + ye(t, (e += r.length));
            },
            function (t, e) {
              const n = t.substr(e, 1);
              if ("." !== n) return "";
              const i = we(t, (e += n.length));
              return ((e += i.length), "" === i ? "" : n + i + ye(t, e));
            },
            function (t, e) {
              const n = xe(t, e);
          ...
          function Ee(t, e) {
            ...
            return null !==
              (n = (function (t, e) {
                ...
                return (
                  (e += n.length),
                  "" === n ? null : { evaluable: new ue(n), cursor: e }
                );
              })(t, e)) && void 0 !== n
              ? n
              : (function (t, e) {
                  const n = t.substr(e, 1);
                  if ("(" !== n) return null;
                  const i = Se(t, (e += n.length));
                  if (!i) return null;
                  ((e = i.cursor), (e += _e(t, e).length));
                  const r = t.substr(e, 1);
                  return (
                    (e += r.length),
                    ")" !== r ? null : { evaluable: i.evaluable, cursor: e }
                  );
                })(t, e);
          }
          function Ve(t, e, n) {
            ...
            return i
              ? ((n += i.length),
                { cursor: (n += _e(e, n).length), operator: i })
              : null;
          }
          const Me = [
            ["**"],
              ...
              (function (t, e) {
                return (n, i) => {
                  ...
                  for (;;) {
                    const r = Ve(e, n, i);
                    if (!r) break;
                    const s = t(n, (i = r.cursor));
                    if (!s) return null;
                    ((i = s.cursor), (o = new me(r.operator, o, s.evaluable)));
                  }
            ...
            function t(e, n) {
              ...
              return o
                ? { cursor: (n = o.cursor), evaluable: new be(r, o.evaluable) }
                : null;
            },
          );
          function Se(t, e) {
            return ((e += _e(t, e).length), Me(t, e));
          }
          function Le(t) {
            var e;
            const n = (function (t) {
              const e = Se(t, 0);
              return e
                ? e.cursor + _e(t, e.cursor).length !== t.length
                  ? null
                  : e.evaluable
                : null;
            })(t);
            return null !== (e = null == n ? void 0 : n.evaluate()) &&
              void 0 !== e
              ? e
              : null;
          }
            ...
            onMouseDown_(t) {
              ...
              (n.addEventListener("mousemove", this.onDocumentMouseMove_),
                ...
                this.emitter.emit("down", {
                  altKey: t.altKey,
                  data: this.computePosition_(He(t, this.elem_)),
                  sender: this,
                  shiftKey: t.shiftKey,
                }));
            }
          ...
          function $e(t) {
            return String(t.toFixed(10)).split(".")[1].replace(/0+$/, "")
              .length;
          }
          function Ge(t, e, n) {
          ...
          class Qe {
            constructor(t, e) {
              ...
              const i = t.createElement("div");
              (i.classList.add(We("k")),
                this.element.appendChild(i),
                (this.knobElement = i));
              const r = t.createElementNS(K, "svg");
              (r.classList.add(We("g")), this.knobElement.appendChild(r));
              const o = t.createElementNS(K, "path");
              (o.classList.add(We("gb")),
                r.appendChild(o),
                (this.guideBodyElem_ = o));
              const s = t.createElementNS(K, "path");
              (s.classList.add(We("gh")),
                r.appendChild(s),
                (this.guideHeadElem_ = s));
              const a = t.createElement("div");
              (a.classList.add(f("tt")()),
            ...
            onDraggingChange_(t) {
              if (null === t.rawValue)
                return void this.element.classList.remove(We(void 0, "drg"));
          ...
          class Xe {
            constructor(t, e) {
              ...
              const i = new ze(this.view.knobElement);
            ...
            constrainValue_(t) {
              ...
              return (
                ...
                void 0 !== r && (o = Math.min(o, r)),
                o
              );
            }
            onInputChange_(t) {
              const e = this.parser_(t.currentTarget.value);
              (a(e) || (this.value.rawValue = this.constrainValue_(e)),
                this.view.refresh());
            }
            onInputKeyDown_(t) {
              const e = Ie(this.baseStep_, Ue(t));
              0 !== e &&
                this.value.setRawValue(
                  this.constrainValue_(this.value.rawValue + e),
                  { forceEmit: !1, last: !1 },
                );
            }
            onInputKeyUp_(t) {
              0 !== Ie(this.baseStep_, Ue(t)) &&
            ...
            computeDraggingValue_(t) {
              ...
              return this.constrainValue_(
                this.originRawValue_ +
                  (t.point.x - t.bounds.width / 2) *
                    this.props.get("draggingScale"),
              );
            }
            onPointerMove_(t) {
          ...
          class Je {
            constructor(t, e) {
              ((this.onChange_ = this.onChange_.bind(this)),
                ...
                this.props_.emitter.on("change", this.onChange_),
                (this.element = t.createElement("div")),
                this.element.classList.add(Ze()),
                e.viewProps.bindClassModifiers(this.element));
              const n = t.createElement("div");
              (n.classList.add(Ze("t")),
                e.viewProps.bindTabIndex(n),
                this.element.appendChild(n),
                (this.trackElement = n));
              const i = t.createElement("div");
              (i.classList.add(Ze("k")),
          ...
          class tn {
            constructor(t, e) {
              ((this.onKeyDown_ = this.onKeyDown_.bind(this)),
                ...
                (this.ptHandler_ = new ze(this.view.trackElement)),
            ...
            onKeyDown_(t) {
              const e = Ie(this.baseStep_, Ke(t));
              0 !== e &&
          ...
          function cn(t) {
            return a(t) ? null : new Jt(pn(t));
          }
          function dn(t, e) {
            const n = t && Xt(t, ee);
            return n ? $e(n.step) : Math.max($e(e), 2);
          }
          function hn(t) {
            const e = (function (t) {
              const e = t ? Xt(t, ee) : null;
          ...
          class mn {
            constructor(t, e) {
              ...
              const r = t.createElement("div");
              (r.classList.add(vn("w")), n.appendChild(r));
              const o = q(t, "check");
              (r.appendChild(o),
                e.value.emitter.on("change", this.onValueChange_),
                (this.value = e.value),
          ...
          class fn {
            ...
            onInputChange_(t) {
              this.value.rawValue = t.currentTarget.checked;
            }
          }
          const bn = {
              id: "input-bool",
              ...
              accept: (t, e) => {
                ...
                const n = A(e, { options: D.optional.custom(sn) });
              ...
              controller: (t) => {
                ...
                return r
                  ? new re(e, {
                      props: new M({ options: r.values.value("options") }),
                      value: n,
                      viewProps: t.viewProps,
                    })
                  : new fn(e, { value: n, viewProps: t.viewProps });
              },
            },
            gn = f("col");
          class _n {
            constructor(t, e) {
              ((this.element = t.createElement("div")),
                ...
                e.foldable.bindExpandedClass(
                  this.element,
                  gn(void 0, "expanded"),
                ),
                _(e.foldable, "completed", w(this.element, gn(void 0, "cpl"))));
              const n = t.createElement("div");
              (n.classList.add(gn("h")), this.element.appendChild(n));
              const i = t.createElement("div");
              (i.classList.add(gn("s")),
                n.appendChild(i),
                (this.swatchElement = i));
              const r = t.createElement("div");
              if (
                (r.classList.add(gn("t")),
                n.appendChild(r),
                (this.textElement = r),
          ...
          function kn(t, e, n, i) {
            const r = Pn(e, n),
              o = Pn(e, i);
            return t.map((t, e) => (t / r[e]) * o[e]);
          }
          function En(t, e) {
            return (
              "object" == typeof t && !a(t) && e in t && "number" == typeof t[e]
            );
          }
          class Vn {
            static black(t = "int") {
              ...
              ((this.mode = e),
                ...
                (this.comps_ = (function (t, e, n) {
                  ...
                  return [
                    "rgb" === e
                      ? Ge(t[0], 0, r[0])
                      : ((o = t[0]), (s = r[0]), o === s ? s : Ye(o, s)),
                    Ge(t[1], 0, r[1]),
                    Ge(t[2], 0, r[2]),
                    Ge(null !== (i = t[3]) && void 0 !== i ? i : 1, 0, 1),
                  ];
                  var o, s;
                })(t, e, n)));
            }
            getComponents(t, e = "int") {
              return xn(
                (function (t, e, n) {
                  const i = kn(t, e.mode, e.type, "int");
                  return kn(Cn[e.mode][n.mode](...i), n.mode, "int", n.type);
                })(
                  yn(this.comps_),
          ...
          class Sn {
            constructor(t, e) {
              ...
              if (
                ...
                const i = t.createElement("div");
                (i.classList.add(Mn("ap")),
                  i.appendChild(this.alphaViews_.palette.element),
                  n.appendChild(i));
                const r = t.createElement("div");
                (r.classList.add(Mn("at")),
                  r.appendChild(this.alphaViews_.text.element),
                  n.appendChild(r),
                  this.element.appendChild(n));
              }
            }
          ...
          function Dn(t) {
            ...
            return A(t, {
              ...
              color: e.optional.object({
                alpha: e.optional.boolean,
                type: e.optional.custom(Ln),
              }),
              expanded: e.optional.boolean,
              picker: e.optional.custom(an),
            });
          }
          function An(t) {
            return t ? 0.1 : 1;
          ...
          function Kn(t) {
            ...
            if (!e) return null;
            const n = [On(e[1]), jn(e[2], 100), jn(e[3], 100)];
            return isNaN(n[0]) || isNaN(n[1]) || isNaN(n[2]) ? null : n;
          }
          function Bn(t) {
            return (e) => {
              const n = Kn(e);
              return n ? new Vn(n, "hsl", t) : null;
            };
          }
          function Hn(t) {
            const e = t.match(
            ...
            if (!e) return null;
            const n = [On(e[1]), jn(e[2], 100), jn(e[3], 100), jn(e[4], 1)];
            return isNaN(n[0]) || isNaN(n[1]) || isNaN(n[2]) || isNaN(n[3])
              ? null
              : n;
          }
          ...
          function $n(t) {
            ...
            if (e)
              return [
                ...
                parseInt(e[2] + e[2], 16),
                parseInt(e[3] + e[3], 16),
                qe(parseInt(e[4] + e[4], 16), 0, 255, 0, 1),
              ];
            const n = t.match(
          ...
          const Xn = [
            ...
            { parser: $n, result: { alpha: !0, mode: "rgb", notation: "hex" } },
            {
              parser: Fn,
          ...
          function ei(t) {
            const e = Ge(Math.floor(t), 0, 255).toString(16);
            return 1 === e.length ? `0${e}` : e;
          }
          function ni(t, e = "#") {
            return `${e}${yn(t.getComponents("rgb")).map(ei).join("")}`;
          }
          function ii(t, e = "#") {
            const n = t.getComponents("rgb");
            return `${e}${[n[0], n[1], n[2], 255 * n[3]].map(ei).join("")}`;
          }
          function ri(t, e) {
            const n = Te("float" === e ? 2 : 0);
            return `rgb(${yn(t.getComponents("rgb", e))
              .map((t) => n(t))
              .join(", ")})`;
          }
          function oi(t) {
          ...
          function li(t, e) {
            const n = Te("float" === e ? 2 : 0),
              i = ["r", "g", "b"];
            return `{${yn(t.getComponents("rgb", e))
              .map((t, e) => `${i[e]}: ${n(t)}`)
              .join(", ")}}`;
          }
          function pi(t) {
          ...
          const hi = [
            ...
            },
            {
              ...
              stringifier: function (t) {
                const e = [Te(0), Re, Re];
                return `hsl(${yn(t.getComponents("hsl"))
                  .map((t, n) => e[n](t))
                  .join(", ")})`;
              },
            },
          ...
          function ui(t) {
            return hi.reduce((e, n) => {
              return (
                e ||
                ((i = n.format).alpha === (r = t).alpha &&
                i.mode === r.mode &&
                i.notation === r.notation &&
                i.type === r.type
                  ? n.stringifier
                  : null)
              );
          ...
          class mi {
            constructor(t, e) {
              ...
              const n = t.createElement("div");
              (n.classList.add(vi("b")), this.element.appendChild(n));
              const i = t.createElement("div");
            ...
            update_() {
              const t = this.value.rawValue,
                ...
                n = new Vn([e[0], e[1], e[2], 0], "rgb"),
                i = new Vn([e[0], e[1], e[2], 255], "rgb"),
                r = ["to right", si(n), si(i)];
              ((this.colorElem_.style.background = `linear-gradient(${r.join(",")})`),
                (this.previewElem_.style.backgroundColor = si(t)));
              const o = qe(e[3], 0, 1, 0, 100);
          ...
          class fi {
            constructor(t, e) {
              ((this.onKeyDown_ = this.onKeyDown_.bind(this)),
                ...
                (this.ptHandler_ = new ze(this.view.element)),
            ...
            handlePointerEvent_(t, e) {
              ...
              const n = t.point.x / t.bounds.width,
                ...
                [r, o, s] = i.getComponents("hsv");
              this.value.setRawValue(new Vn([r, o, s, n], "hsv"), e);
            }
            onPointerDown_(t) {
              this.handlePointerEvent_(t.data, { forceEmit: !1, last: !1 });
            }
            ...
            onKeyDown_(t) {
              const e = Ie(An(!0), Ke(t));
              if (0 === e) return;
              const n = this.value.rawValue,
                [i, r, o, s] = n.getComponents("hsv");
              this.value.setRawValue(new Vn([i, r, o, s + e], "hsv"), {
                forceEmit: !1,
                last: !1,
              });
            }
          ...
          function wi(t, e, n) {
            return new Xe(t, {
              ...
              props: M.fromObject({
                ...
                formatter: ((i = e.colorType), Te("float" === i ? 2 : 0)),
              }),
          ...
          class yi {
                  ...
                  Ne({
                    ...
                    backward: (t, n) => {
                      const i = this.colorMode.rawValue,
                        r = t.rawValue.getComponents(i, this.colorType_);
                      return (
                        (r[e] = n.rawValue),
                        new Vn(xn(yn(r), r[3]), i, this.colorType_)
                      );
                    },
                  });
                }),
            ...
            onModeSelectChange_(t) {
              ((this.colorMode.rawValue = t.currentTarget.value),
          ...
          class Ci {
            ...
            update_() {
              ...
              this.markerElem_.style.backgroundColor = ri(
                new Vn([e, 100, 100], "hsv"),
              );
              const n = qe(e, 0, 360, 0, 100);
          ...
          class Pi {
            ...
            handlePointerEvent_(t, e) {
              ...
              const n = qe(
                ...
                i = this.value.rawValue,
                [, r, o, s] = i.getComponents("hsv");
              this.value.setRawValue(new Vn([n, r, o, s], "hsv"), e);
            }
            onPointerDown_(t) {
              this.handlePointerEvent_(t.data, { forceEmit: !1, last: !1 });
            }
            ...
            onKeyDown_(t) {
              const e = Ie(An(!1), Ke(t));
              if (0 === e) return;
              const n = this.value.rawValue,
                [i, r, o, s] = n.getComponents("hsv");
              this.value.setRawValue(new Vn([i + e, r, o, s], "hsv"), {
                forceEmit: !1,
                last: !1,
              });
            }
          ...
          class Ei {
            constructor(t, e) {
              ...
              ((n.height = 64),
                (n.width = 64),
                n.classList.add(ki("c")),
                this.element.appendChild(n),
                (this.canvasElement = n));
              const i = t.createElement("div");
              (i.classList.add(ki("m")),
                this.element.appendChild(i),
                (this.markerElem_ = i),
                this.update_());
            }
            update_() {
              ...
              const s = qe(e[1], 0, 100, 0, 100);
              this.markerElem_.style.left = `${s}%`;
              const a = qe(e[2], 0, 100, 100, 0);
          ...
          class Vi {
            ...
            handlePointerEvent_(t, e) {
              if (!t.point) return;
              const n = qe(t.point.x, 0, t.bounds.width, 0, 100),
                i = qe(t.point.y, 0, t.bounds.height, 100, 0),
                [r, , , o] = this.value.rawValue.getComponents("hsv");
              this.value.setRawValue(new Vn([r, n, i, o], "hsv"), e);
            }
            onPointerDown_(t) {
              this.handlePointerEvent_(t.data, { forceEmit: !1, last: !1 });
            }
            ...
            onKeyDown_(t) {
              Be(t.key) && t.preventDefault();
              const [e, n, i, r] = this.value.rawValue.getComponents("hsv"),
                o = An(!1),
                s = Ie(o, Ke(t)),
                a = Ie(o, Ue(t));
              (0 === s && 0 === a) ||
                this.value.setRawValue(new Vn([e, n + s, i + a, r], "hsv"), {
                  forceEmit: !1,
                  last: !1,
                });
            }
          ...
          class Mi {
            constructor(t, e) {
              ((this.value = e.value),
                (this.viewProps = e.viewProps),
                (this.hPaletteC_ = new Pi(t, {
                  value: this.value,
                  viewProps: this.viewProps,
                })),
                (this.svPaletteC_ = new Vi(t, {
                  value: this.value,
                  viewProps: this.viewProps,
                })),
                (this.alphaIcs_ = e.supportsAlpha
                  ? {
                      ...
                      text: new Xe(t, {
                        ...
                        value: V(0, { constraint: new Zt({ min: 0, max: 1 }) }),
                        viewProps: this.viewProps,
                      }),
                    }
                  : null),
                this.alphaIcs_ &&
                  Ne({
                    ...
                    backward: (t, e) => {
                      ...
                      return ((n[3] = e.rawValue), new Vn(n, t.rawValue.mode));
                    },
                  }),
                (this.textC_ = new yi(t, {
          ...
          class Li {
            constructor(t, e) {
              ((this.onValueChange_ = this.onValueChange_.bind(this)),
                ...
                e.viewProps.bindClassModifiers(this.element));
              const n = t.createElement("div");
              (n.classList.add(Si("sw")),
                this.element.appendChild(n),
                (this.swatchElem_ = n));
              const i = t.createElement("button");
              (i.classList.add(Si("b")),
                e.viewProps.bindDisabled(i),
                this.element.appendChild(i),
                (this.buttonElement = i),
                this.update_());
            ...
            update_() {
              this.swatchElem_.style.backgroundColor = ii(this.value.rawValue);
            }
            onValueChange_() {
              this.update_();
            }
          ...
          class Ai {
            constructor(t, e) {
              ((this.onButtonBlur_ = this.onButtonBlur_.bind(this)),
                ...
                (this.value = e.value),
                (this.viewProps = e.viewProps),
                (this.foldable_ = nt.create(e.expanded)),
                (this.swatchC_ = new Di(t, {
                  value: this.value,
                  viewProps: this.viewProps,
                })));
              ...
              (n.addEventListener("blur", this.onButtonBlur_),
                ...
                (this.textC_ = new ce(t, {
                  parser: e.parser,
                  props: M.fromObject({ formatter: e.formatter }),
                  value: this.value,
                  viewProps: this.viewProps,
                })),
                (this.view = new _n(t, {
              ...
              (i.view.allFocusableElements.forEach((t) => {
                ...
                this.popC_
                  ...
                  : this.view.pickerElement &&
                    ...
                    rt(this.foldable_, this.view.pickerElement)));
            }
            get textController() {
              return this.textC_;
            }
            onButtonBlur_(t) {
              ...
              (e && this.view.element.contains(e)) ||
          ...
          function Ti(t) {
            return yn(t.getComponents("rgb")).reduce(
          ...
          function ji(t) {
            return (
              t
                ...
                .reduce(
                  (t, e, n) =>
                    (t << 8) | (255 & Math.floor(3 === n ? 255 * e : e)),
                  0,
                ) >>> 0
            );
          }
          function Ri(t) {
            return "number" != typeof t
              ? Vn.black()
              : new Vn([((e = t) >> 16) & 255, (e >> 8) & 255, 255 & e], "rgb");
            var e;
          }
          function Oi(t) {
            return "number" != typeof t
          ...
          const Bi = {
              ...
              binding: {
                reader: (t) => Ui(Tn(t.params)),
                equals: Vn.equals,
                writer: (t) => {
                  return (
                    (e = Vn.isRgbaColorObject(t.initialValue)),
                    (n = Tn(t.params)),
                    (t, i) => {
                      e
                        ? (function (t, e, n) {
              ...
              binding: {
                reader: (t) => {
                  ...
                  return (function (t) {
                    const e = Jn[t];
                    return (n) => {
                      if ("string" != typeof n) return Vn.black(t);
                      const i = e.reduce((t, e) => t || e(n), null);
                      return null != i ? i : Vn.black(t);
                    };
                  })(null !== (e = Tn(t.params)) && void 0 !== e ? e : "int");
                },
                equals: Vn.equals,
                writer: (t) => {
                  const e = Zn(t.initialValue, Tn(t.params));
                  if (!e) throw d.shouldNeverHappen();
                  const n = (function (t) {
                    const e = ui(t);
                    return e
          ...
          function Yi(t, e) {
            return "step" in t && !a(t.step) ? new ee(t.step, e) : null;
          }
          function Wi(t) {
            return a(t.max) || a(t.min)
              ? a(t.max) && a(t.min)
                ? null
                : new te({ max: t.max, min: t.min })
          ...
          const Qi = {
            ...
            controller: (t) => {
              ...
              const o =
                  null !==
                    (e = "format" in t.params ? t.params.format : void 0) &&
                  void 0 !== e
                    ? e
                    : Te(dn(i, n.rawValue)),
                s = i && Xt(i, Zt);
          ...
          class Xi {
            ...
            static isObject(t) {
              if (a(t)) return !1;
              return "number" == typeof t.x && "number" == typeof t.y;
            }
            static equals(t, e) {
          ...
          class tr {
            constructor(t, e) {
              ((this.element = t.createElement("div")),
                ...
                e.viewProps.bindClassModifiers(this.element),
                g(e.expanded, w(this.element, Ji(void 0, "expanded"))));
              const n = t.createElement("div");
              (n.classList.add(Ji("h")), this.element.appendChild(n));
              const i = t.createElement("button");
              (i.classList.add(Ji("b")),
              ...
              const r = t.createElement("div");
              if (
                (r.classList.add(Ji("t")),
                n.appendChild(r),
                (this.textElement = r),
                "inline" === e.pickerLayout)
              ) {
                const e = t.createElement("div");
                (e.classList.add(Ji("p")),
                  this.element.appendChild(e),
                  (this.pickerElement = e));
              } else this.pickerElement = null;
            }
          ...
          class nr {
            constructor(t, e) {
              ((this.onFoldableChange_ = this.onFoldableChange_.bind(this)),
                ...
                "popup" === e.layout &&
                  this.element.classList.add(er(void 0, "p")),
                e.viewProps.bindClassModifiers(this.element));
              const n = t.createElement("div");
              (n.classList.add(er("p")),
                e.viewProps.bindTabIndex(n),
                this.element.appendChild(n),
                (this.padElement = n));
              const i = t.createElementNS(K, "svg");
              (i.classList.add(er("g")),
                this.padElement.appendChild(i),
                (this.svgElem_ = i));
              const r = t.createElementNS(K, "line");
              (r.classList.add(er("ax")),
              ...
              const o = t.createElementNS(K, "line");
              (o.classList.add(er("ax")),
          ...
          function ir(t, e, n) {
            return [Ie(e[0], Ke(t)), Ie(e[1], Ue(t)) * (n ? 1 : -1)];
          }
          class rr {
            constructor(t, e) {
              ((this.onPadKeyDown_ = this.onPadKeyDown_.bind(this)),
                ...
                (this.ptHandler_ = new ze(this.view.padElement)),
                this.ptHandler_.emitter.on("down", this.onPointerDown_),
                this.ptHandler_.emitter.on("move", this.onPointerMove_),
                this.ptHandler_.emitter.on("up", this.onPointerUp_),
            ...
            handlePointerEvent_(t, e) {
              ...
              const n = this.maxValue_,
                i = qe(t.point.x, 0, t.bounds.width, -n, +n),
                r = qe(
              ...
              this.value.setRawValue(new Xi(i, r), e);
            }
            onPointerDown_(t) {
              this.handlePointerEvent_(t.data, { forceEmit: !1, last: !1 });
            }
            ...
            onPadKeyDown_(t) {
              Be(t.key) && t.preventDefault();
              const [e, n] = ir(t, this.baseSteps_, this.invertsY_);
              (0 === e && 0 === n) ||
                this.value.setRawValue(
                  new Xi(this.value.rawValue.x + e, this.value.rawValue.y + n),
                  { forceEmit: !1, last: !1 },
                );
            }
            onPadKeyUp_(t) {
          ...
          class or {
            ...
            onPopupChildBlur_(t) {
              ...
              const e = this.popC_.view.element,
                n = W(t);
              (n && e.contains(n)) ||
                (n && n === this.view.buttonElement && !B(e.ownerDocument)) ||
                (this.popC_.shows.rawValue = !1);
            }
            onPopupChildKeydown_(t) {
              this.popC_
          ...
          const ar = {
            toComponents: (t) => t.getComponents(),
            fromComponents: (t) => new sr(...t),
          };
          function lr(t) {
            return sr.isObject(t) ? new sr(t.x, t.y, t.z) : new sr();
          }
          function pr(t, e) {
          ...
          const dr = {
            ...
            type: "input",
            accept: (t, e) => {
              if (!sr.isObject(t)) return null;
              const n = D,
                i = A(e, {
                  x: n.optional.custom(ln),
                  y: n.optional.custom(ln),
                  z: n.optional.custom(ln),
                });
              return i ? { initialValue: t, params: i } : null;
            },
            binding: {
              ...
              constraint: (t) => {
                return new zi({
                  ...
                  components: [
                    Fr(
                      "x" in (e = t.params) ? e.x : void 0,
                      (n = t.initialValue).x,
                    ),
                    Fr("y" in e ? e.y : void 0, n.y),
                    Fr("z" in e ? e.z : void 0, n.z),
                  ],
                });
                var e, n;
              },
            ...
            controller: (t) => {
              const e = t.value,
                n = t.constraint;
              if (!(n instanceof zi)) throw d.shouldNeverHappen();
              return new Gi(t.document, {
                assembly: ar,
                axes: [
                  cr(e.rawValue.x, n.components[0]),
                  cr(e.rawValue.y, n.components[1]),
                  cr(e.rawValue.z, n.components[2]),
                ],
                parser: Le,
                value: e,
                viewProps: t.viewProps,
          ...
          const ur = {
            toComponents: (t) => t.getComponents(),
            fromComponents: (t) => new hr(...t),
          };
          function vr(t) {
            return hr.isObject(t) ? new hr(t.x, t.y, t.z, t.w) : new hr();
          }
          function mr(t, e) {
            (t.writeProperty("x", e.x),
              t.writeProperty("y", e.y),
          ...
          const fr = {
            ...
            type: "input",
            accept: (t, e) => {
              if (!hr.isObject(t)) return null;
              const n = D,
                i = A(e, {
                  x: n.optional.custom(ln),
                  y: n.optional.custom(ln),
                  z: n.optional.custom(ln),
                  w: n.optional.custom(ln),
                });
              return i ? { initialValue: t, params: i } : null;
            },
            binding: {
              ...
              return new Gi(t.document, {
                ...
                axes: e.rawValue.getComponents().map((t, e) => {
                  return (
                    (i = t),
                    {
                      baseStep: hn((r = n.components[e])),
                      constraint: r,
                      textProps: M.fromObject({
                        draggingScale: un(r, i),
                        formatter: Te(dn(r, i)),
                      }),
                    }
                  );
          ...
          const br = {
              ...
              controller: (t) => {
                ...
                return r
                  ...
                  : new ce(e, {
                      parser: (t) => t,
                      props: M.fromObject({ formatter: Fe }),
                      value: n,
                      viewProps: t.viewProps,
                    });
              },
            },
            gr = { defaultInterval: 200, defaultLineCount: 3 },
            _r = f("mll");
          class wr {
            constructor(t, e) {
          ...
          const kr = {
              ...
              accept: (t, e) => {
                if ("boolean" != typeof t) return null;
                const n = A(e, { lineCount: D.optional.number });
                return n ? { initialValue: t, params: n } : null;
              },
              binding: { reader: (t) => de },
              controller: (t) => {
          ...
          class Vr {
            constructor(t, e) {
              ...
              (n.classList.add(Er("g")),
                ...
                this.element.appendChild(n),
                (this.svgElem_ = n));
              const i = t.createElementNS(K, "polyline");
              (this.svgElem_.appendChild(i), (this.lineElem_ = i));
              const r = t.createElement("div");
              (r.classList.add(Er("t"), f("tt")()),
                this.element.appendChild(r),
                (this.tooltipElem_ = r),
                e.value.emitter.on("change", this.onValueUpdate_),
                (this.value = e.value),
            ...
            update_() {
              const t = this.svgElem_.getBoundingClientRect(),
                ...
                r = [];
              (this.value.rawValue.forEach((o, s) => {
                if (void 0 === o) return;
                const a = qe(s, 0, e, 0, t.width),
                  l = qe(o, n, i, t.height, 0);
                r.push([a, l].join(","));
              }),
                this.lineElem_.setAttributeNS(null, "points", r.join(" ")));
              const o = this.tooltipElem_,
                s = this.value.rawValue[this.cursor_.rawValue];
              if (void 0 === s) return void o.classList.remove(Er("t", "a"));
              const a = qe(this.cursor_.rawValue, 0, e, 0, t.width),
                l = qe(s, n, i, t.height, 0);
              ((o.style.left = `${a}px`),
                (o.style.top = `${l}px`),
                (o.textContent = `${this.formatter_(s)}`),
          ...
          class Mr {
            constructor(t, e) {
              if (
                ...
                const t = new ze(this.view.element);
            ...
            onGraphMouseMove_(t) {
              ...
              this.cursor_.rawValue = Math.floor(
                qe(t.offsetX, 0, e.width, 0, this.value.rawValue.length),
              );
            }
            ...
            onGraphPointerMove_(t) {
              this.cursor_.rawValue = t.data.point
                ? Math.floor(
                    qe(
                      t.data.point.x,
                      0,
          ...
          function Sr(t) {
            return "format" in t && !a(t.format) ? t.format : Te(2);
          }
          function Lr(t) {
                  ...
                  ? (function (t) {
                      ...
                      return new Mr(t.document, {
                        ...
                        props: M.fromObject({
                          maxValue:
                            null !==
                              (n = "max" in t.params ? t.params.max : null) &&
                            void 0 !== n
                              ? n
                              : 100,
                          minValue:
                            null !==
                              (i = "min" in t.params ? t.params.min : null) &&
                            void 0 !== i
                              ? i
                              : 0,
                        }),
          ...
          function Tr(t, e) {
            return 0 === e
              ? new Ht()
              : new zt(t, null != e ? e : gr.defaultInterval);
          }
          class jr {
            constructor() {
            ...
            register(t) {
              "blade" === t.type
                ...
                : "input" === t.type
                  ...
                  : "monitor" === t.type &&
                    this.pluginsMap_.monitors.unshift(t);
            }
            createInput(t, e, n) {
              if (a(e.read()))
                throw new d({
              ...
              const i = this.pluginsMap_.inputs.reduce(
                (i, r) =>
                  null != i
                    ...
                    : (function (t, e) {
                        var n;
                        const i = t.accept(e.target.read(), e.params);
                        if (a(i)) return null;
                        const r = D,
                          o = {
                            target: e.target,
                          ...
                          s = t.binding.reader(o),
                          l = t.binding.constraint
                            ? t.binding.constraint(o)
                            : void 0,
                          p = V(s(i.initialValue), {
                            constraint: l,
                          ...
                          c = new qt({
                            ...
                            target: e.target,
                            value: p,
                            writer: t.binding.writer(o),
                          }),
                          d = r.optional.boolean(e.params.disabled).value,
                          h = r.optional.boolean(e.params.hidden).value,
                          u = t.controller({
                            constraint: l,
                            document: e.document,
                            initialValue: i.initialValue,
                            params: i.params,
                            value: c.value,
                            viewProps: F.create({ disabled: d, hidden: h }),
                          });
                      ...
                      })(r, { document: t, target: e, params: n }),
                null,
              );
              if (i) return i;
              throw new d({
                    ...
                    : (function (t, e) {
                        ...
                        const l = t.binding.reader({
                              ...
                              (i =
                                null !==
                                  ...
                                  : t.binding.defaultBufferSize &&
                                    t.binding.defaultBufferSize(s.params)) &&
                            void 0 !== i
                              ? i
                              : 1,
                          ...
                          d = new Wt({
                            reader: l,
                            target: e.target,
                            ticker: Tr(e.document, c),
                            value: Gt(p),
                          }),
                          h = o.optional.boolean(e.params.disabled).value,
                          u = o.optional.boolean(e.params.hidden).value,
                          v = t.controller({
                            document: e.document,
                            params: s.params,
                            value: d.value,
                            viewProps: F.create({ disabled: h, hidden: u }),
                          });
                      ...
                      })(r, { document: t, params: n, target: e }),
                null,
              );
              if (i) return i;
              throw new d({
                ...
                (n, i) =>
                  null != n
                    ...
                    : (function (t, e) {
                        ...
                        if (!n) return null;
                        const i = D.optional.boolean(e.params.disabled).value,
                          r = D.optional.boolean(e.params.hidden).value;
                        return t.controller({
                          blade: et(),
                          document: e.document,
                          ...
                          viewProps: F.create({ disabled: i, hidden: r }),
                        });
                      })(i, { document: t, params: e }),
                null,
              );
              if (!n)
                throw new d({ type: "nomatchingview", context: { params: e } });
              return n;
            }
            createBladeApi(t) {
              if (t instanceof lt) return new at(t);
              if (t instanceof ct) return new pt(t);
              if (t instanceof yt) return new vt(t, this);
              const e = this.pluginsMap_.blades.reduce(
                (e, n) =>
                  null != e ? e : n.api({ controller: t, pool: this }),
                null,
              );
              if (!e) throw d.shouldNeverHappen();
              return e;
          ...
          function Rr(t) {
            return Xi.isObject(t) ? new Xi(t.x, t.y) : new Xi();
          }
          function Or(t, e) {
          ...
          function Ir(t, e) {
            const n = e instanceof zi ? e.components[1] : void 0,
              i = Nr(e instanceof zi ? e.components[0] : void 0, t.x),
              r = Nr(n, t.y);
            return Math.max(i, r);
          }
          function Ur(t, e) {
          ...
          const Br = {
            ...
            controller: (t) => {
              const e = t.document,
                n = t.value,
                i = t.constraint;
              if (!(i instanceof zi)) throw d.shouldNeverHappen();
              const r = "expanded" in t.params ? t.params.expanded : void 0,
                o = "picker" in t.params ? t.params.picker : void 0;
              return new or(e, {
                axes: [
                  Ur(n.rawValue.x, i.components[0]),
                  Ur(n.rawValue.y, i.components[1]),
                ],
                expanded: null != r && r,
                invertsY: Kr(t.params),
                maxValue: Ir(n.rawValue, i),
                parser: Le,
          ...
          const $r = {
            ...
            controller(t) {
              const e = new Jt(pn(t.params.options)),
                n = V(t.params.value, { constraint: e }),
                i = new re(t.document, {
                  props: new M({ options: e.values.value("options") }),
                  value: n,
                  viewProps: t.viewProps,
                });
              return new Et(t.document, {
                blade: t.blade,
                props: M.fromObject({ label: t.params.label }),
                valueController: i,
              });
            ...
            api: (t) =>
              t.controller instanceof Et &&
              t.controller.valueController instanceof re
                ? new Hr(t.controller)
                : null,
          };
          class Gr extends mt {
            ...
            importPreset(t) {
              (!(function (t, e) {
                t.forEach((t) => {
                  const n = e[t.target.presetKey];
                  void 0 !== n && t.writer(t.target, t.reader(n));
                });
              })(
          ...
          const Wr = {
              ...
              controller(t) {
                ...
                const i = null !== (e = t.params.value) && void 0 !== e ? e : 0,
                  r = new Zt({ max: t.params.max, min: t.params.min }),
                  o = new rn(t.document, {
                    baseStep: 1,
                    parser: Le,
                    sliderProps: new M({
                    ...
                    textProps: M.fromObject({
                      draggingScale: un(void 0, i),
                      formatter:
                        null !== (n = t.params.format) && void 0 !== n ? n : Ae,
                    }),
              ...
              api: (t) =>
                t.controller instanceof Et &&
                t.controller.valueController instanceof rn
                  ? new zr(t.controller)
                  : null,
            },
            Qr = {
              ...
              api: (t) =>
                t.controller instanceof Et &&
                t.controller.valueController instanceof ce
                  ? new qr(t.controller)
                  : null,
            };
          function Xr(t, e, n) {
          ...
          ((t.BladeApi = e),
            (t.ButtonApi = u),
            (t.FolderApi = mt),
            (t.InputBindingApi = at),
            (t.ListApi = Hr),
            (t.MonitorBindingApi = pt),
            (t.Pane = class extends Gr {
              constructor(t) {
                var e, n;
                const i = null != t ? t : {},
                  r = null !== (e = i.document) && void 0 !== e ? e : H(),
                  o = (function () {
                    const t = new jr();
                    return (
                      [
                ...
                (super(
                  new Yr(r, {
                    expanded: i.expanded,
                    blade: et(),
                    props: M.fromObject({ title: i.title }),
                    viewProps: F.create(),
                  }),
                  o,
                ),
              ...
              embedPluginStyle_(t) {
                t.css && Xr(this.document, `plugin-${t.id}`, t.css);
              }
              setUpDefaultPlugins_() {
                (Xr(
                  ...
                  this.registerPlugin({ plugins: [Wr, $r, Bt, Qr] }));
              }
            }),
            (t.SeparatorApi = Vt),
            (t.SliderApi = zr),
    ...
    9: [
      function (t, e, n) {
        ...
        ((l.textContent = "previous sketch"),
          document.body.appendChild(l),
          p("back", "20px", "../01/bundle.html"),
          p("next sketch", "120px", "../03/bundle.html"));
        const c = { dimensions: [window.innerWidth, window.innerHeight] },
          d = (() => {
            const t = new s.Pane();
            let e;
            return (
              (e = t.addFolder({ title: "change to regenerate" })),
              e.addInput(a, "seed"),
              e.addInput(a, "bgColor"),
              (e = t.addFolder({ title: "circle settings" })),
              e.addInput(a, "arcRadius", { min: 50, max: 500 }),
              e.addInput(a, "circleColor"),
              (e = t.addFolder({ title: "rectangle settings" })),
              e.addInput(a, "numLines", { min: 1, max: 100, step: 1 }),
              e.addInput(a, "lineWidth", { min: 1, max: 20 }),
              e.addInput(a, "lineLength", { min: 10, max: 200 }),
              e.addInput(a, "rectColor"),
              t
            );
          })();
        i(
          () =>
            ({ context: t, width: e, height: n }) => {
              (o.setSeed(a.seed),
                (t.fillStyle = `${a.bgColor}`),
                t.fillRect(0, 0, e, n),
                (t.fillStyle = `${a.rectColor}`),
                (t.strokeStyle = "white"));
              const i = 0.5 * e,
                s = 0.5 * n,
                l = a.lineWidth,
              ...
              for (let e = 0; e < d; e++) {
                ...
                ((h = i + c * Math.sin(v)),
                  ...
                  t.translate(h, u),
                  t.rotate(-v),
                  t.scale(o.range(0.5, 2), 1),
                  t.beginPath(),
                  t.rect(0.5 * l, o.range(0, 0.5 * -p), l, p),
                  t.fill(),
                  t.restore(),
                  t.save(),
                  t.translate(i, s),
                  t.rotate(-v),
                  (t.lineWidth = o.range(5, 20)),
                  t.beginPath(),
                  t.arc(
                    0,
                    0,
